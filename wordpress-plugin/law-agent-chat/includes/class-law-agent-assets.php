...
class Law_Agent_Assets {
	...
	private static function strings() {
		return array(
			...
			'cTitle'           => __( 'طلباتي', 'law-agent-chat' ),
			'cEmpty'           => __( 'لم تطلب أي خدمة بعد.', 'law-agent-chat' ),
			'cLoadError'       => __( 'تعذّر تحميل الطلبات. حاول لاحقًا.', 'law-agent-chat' ),
			'cNotFound'        => __( 'لم نعثر على هذا الطلب.', 'law-agent-chat' ),
			'cBack'            => __( 'العودة إلى طلباتي', 'law-agent-chat' ),
			'cNumber'          => __( 'رقم الطلب', 'law-agent-chat' ),
			'cService'         => __( 'الخدمة', 'law-agent-chat' ),
			'cNotes'           => __( 'وصف الحالة', 'law-agent-chat' ),
			'cStatusInProgress' => __( 'قيد العمل', 'law-agent-chat' ),
			'cStatusCompleted' => __( 'مكتملة', 'law-agent-chat' ),
			'cReceived'        => __( 'تم استلام الطلب', 'law-agent-chat' ),
			...
			'cNoSession'       => __( 'لا توجد محادثة مرتبطة بهذا الطلب.', 'law-agent-chat' ),
			...
			'svcOrder'         => __( 'اطلب الخدمة', 'law-agent-chat' ),
			'svcOrderPriced'   => __( 'اطلب الخدمة — %s', 'law-agent-chat' ),
			'svcLoginToOrder'  => __( 'سجّل دخولك لطلب الخدمة', 'law-agent-chat' ),
			'svcLoginToBook'   => __( 'سجّل دخولك لحجز استشارة', 'law-agent-chat' ),
			'svcNotesTitle'    => __( 'صف حالتك باختصار', 'law-agent-chat' ),
			'svcNotesHint'     => __( 'ما الذي تريد من المحامي مراجعته أو فعله؟ كلما كان الوصف أوضح كان العمل أسرع.', 'law-agent-chat' ),
			'svcNotesRequired' => __( 'اكتب وصفًا مختصرًا لحالتك للمتابعة.', 'law-agent-chat' ),
			'svcContinue'      => __( 'متابعة إلى الدفع', 'law-agent-chat' ),
			'svcCancel'        => __( 'إلغاء', 'law-agent-chat' ),
			'svcEmpty'         => __( 'لا توجد خدمات متاحة حاليًا.', 'law-agent-chat' ),
			'svcLoadError'     => __( 'تعذّر تحميل الخدمات. حاول لاحقًا.', 'law-agent-chat' ),
			'svcOpenOrder'     => __( 'لديك طلب مفتوح لهذه الخدمة بالفعل.', 'law-agent-chat' ),
			'svcInactive'      => __( 'هذه الخدمة غير متاحة حاليًا.', 'law-agent-chat' ),

			/* the assistant's suggestion */
			'sugTitle'         => __( 'يبدو أن حالتك تحتاج: %s', 'law-agent-chat' ),
			'sugAnonBody'      => __( 'سجّل دخولك لطلب هذه الخدمة من محامٍ.', 'law-agent-chat' ),
